...
<head>
    ...
    <title>Borial - Responsive Bootstrap 4 Landing Template</title>
    ...
    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" href="<?= base_url() . 'assets/borial/css/bootstrap.min.css' ?>" type="text/css">

    <!-- Magnificpopup Css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() . 'assets/borial/css/magnific-popup.css' ?>">

    <!--Material Icon -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() . 'assets/borial/css/materialdesignicons.min.css' ?>" />

    <!--Font Awesome -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() . 'assets/borial/css/font-awesome.min.css' ?>" />

    <!--Slider-->
    <link rel="stylesheet" href="<?= base_url() . 'assets/borial/css/owl.carousel.css' ?>" />
    <link rel=" stylesheet" href="<?= base_url() . 'assets/borial/css/owl.theme.css' ?>" />
    <link rel="stylesheet" href="<?= base_url() . 'assets/borial/css/owl.transitions.css' ?>" />

    <!-- Custom  Css -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() . 'assets/borial/css/style.css' ?>" />
</head>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky">
        <div class="container">
            <a class="navbar-brand logo" href="#">Borial</a>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center">
                        <h4 class="title-heading text-uppercase">Welcome to Borial</h4>
        ...
        <div class="container">
            ...
            <div class="row mt-4">
                <div class="col-lg-6">
                    <div class="services-blog mt-4">
                        <div>
                            <img src="<?= base_url() . 'assets/borial/images/services/Briefcase.png' ?>" class="img-fluid" alt="">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="services-blog mt-4">
                        <div>
                            <img src="<?= base_url() . 'assets/borial/images/services/Envelope.png' ?>" class="img-fluid" alt="">
                        </div>
                        <div class="service-head">
                            <h4 class="mb-2">Email marketing</h4>
                            <p class="text-muted mb-0">The new common language will be more simple and regular than the existing European languages. It will be as simple as Occidental</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2">
                <div class="col-lg-6">
                    <div class="services-blog mt-4">
                        <div>
                            <img src="<?= base_url() . 'assets/borial/images/services/DrawingTablet.png' ?>" class="img-fluid" alt="">
                        </div>
                        <div class="service-head">
                            <h4>Market Analysis</h4>
                            <p class="text-muted mb-0">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur adipisci velit sed quia non numquam modi eius.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="services-blog mt-4">
                        <div>
                            <img src="<?= base_url() . 'assets/borial/images/services/Rulers.png' ?>" class="img-fluid" alt="">
                        </div>
                        <div class="service-head">
        ...
        <div class="container-fluid">
            <div class="row container-grid mt-5 projects-wrapper">
                ...
                <div class="img-max-width profile business">
                    <div class="item-box">
                        <a class="cbox-gallary1 mfp-image" href="<?= base_url() . 'assets/borial/images/portfolio/work-3.jpg' ?>" title="Project Name">
                            <img class="item-container" src="<?= base_url() . 'assets/borial/images/portfolio/work-3.jpg' ?>" alt="3" />
                            <div class="item-mask">
                                <div class="item-caption">
                                    <h5 class="text-light">Project Name</h5>
                                    <p class="text-light">client: Donald Jerry</p>
                ...
                <div class="img-max-width marketing">
                    <div class="item-box">
                        <a class="cbox-gallary1 mfp-image" href="<?= base_url() . 'assets/borial/images/portfolio/work-4.jpg' ?>" title="Project Name">
                            <img class="item-container" src="<?= base_url() . 'assets/borial/images/portfolio/work-4.jpg' ?>" alt="4" />
                            <div class="item-mask">
                                <div class="item-caption">
                                    <h5 class="text-light">Project Name</h5>
                                    <p class="text-light">client: Donald Jerry</p>
                ...
                <div class="img-max-width finance marketing">
                    <div class="item-box">
                        <a class="cbox-gallary1 mfp-image" href="<?= base_url() . 'assets/borial/images/portfolio/work-5.jpg' ?>" title="Project Name">
                            <img class="item-container" src="<?= base_url() . 'assets/borial/images/portfolio/work-5.jpg' ?>" alt="5" />
                            <div class="item-mask">
                                <div class="item-caption">
                                    <h5 class="text-light">Project Name</h5>
                                    <p class="text-light">client: Donald Jerry</p>
                ...
                <div class="img-max-width profile marketing">
                    <div class="item-box">
                        <a class="cbox-gallary1 mfp-image" href="<?= base_url() . 'assets/borial/images/portfolio/work-6.jpg' ?>" title="Project Name">
                            <img class="item-container" src="<?= base_url() . 'assets/borial/images/portfolio/work-6.jpg' ?>" alt="6" />
                            <div class="item-mask">
                                <div class="item-caption">
                                    <h5 class="text-light">Project Name</h5>
                                    <p class="text-light">client: Donald Jerry</p>
                ...
                <div class="img-max-width business">
                    <div class="item-box">
                        <a class="cbox-gallary1 mfp-image" href="<?= base_url() . 'assets/borial/images/portfolio/work-7.jpg' ?>" title="Project Name">
                            <img class="item-container" src="<?= base_url() . 'assets/borial/images/portfolio/work-7.jpg' ?>" alt="7" />
                            <div class="item-mask">
                                <div class="item-caption">
                                    <h5 class="text-light">Project Name</h5>
                                    <p class="text-light">client: Donald Jerry</p>
                ...
                <div class="img-max-width marketing">
                    <div class="item-box">
                        <a class="cbox-gallary1 mfp-image" href="<?= base_url() . 'assets/borial/images/portfolio/work-8.jpg' ?>" title="Project Name">
                            <img class="item-container" src="<?= base_url() . 'assets/borial/images/portfolio/work-8.jpg' ?>" alt="8" />
                            <div class="item-mask">
                                <div class="item-caption">
                                    <h5 class="text-light">Project Name</h5>
                                    <p class="text-light">client: Donald Jerry</p>
    ...
    <section class="section" id="client">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class=" text-center">
                        <h4 class="title-heading text-uppercase">Our Testimonial</h4>
                        <p class="title-desc text-muted">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime</p>
                    </div>
                </div>
            </div>
                    ...
                    <div id="owl-demo" class="owl-carousel">
                        ...
                        <div class="testi-box">
                            <div class="text-center mt-4">
                                ...
                                <div class="mt-4">
                                    <img src="<?= base_url() . 'assets/borial/images/client/11.jpg' ?>" alt="" class="img-fluid rounded-circle testi-user mx-auto d-block">
                                </div>
                        ...
                        <div class="testi-box">
                            <div class="text-center mt-4">
                                ...
                                <div class="mt-4">
                                    <img src="<?= base_url() . 'assets/borial/images/client/12.jpg' ?>" alt="" class="img-fluid rounded-circle testi-user mx-auto d-block">
                                </div>
                                <div class="img-post text-center">
                        ...
                        <div class="testi-box">
                            <div class="text-center mt-4">
                                ...
                                <div class="mt-4">
                                    <img src="<?= base_url() . 'assets/borial/images/client/13.jpg' ?>" alt="" class="img-fluid rounded-circle testi-user mx-auto d-block">
                                </div>
                                <div class="img-post text-center">
    ...
    <section class="section" id="team">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center">
                        <h4 class="title-heading text-uppercase">Our Team Member</h4>
                        <p class="title-desc text-muted">Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-4">
                <div class="col-lg-3">
                    <div class="team-member mt-4 text-center">
                        <img src="<?= base_url() . 'assets/borial/images/team/11.jpg' ?>" class="img-fluid" alt="">
                        <div>
                ...
                <div class="col-lg-3">
                    <div class="team-member mt-4 text-center">
                        <img src="<?= base_url() . 'assets/borial/images/team/12.jpg' ?>" class="img-fluid" alt="">
                        <div>
                ...
                <div class="col-lg-3">
                    <div class="team-member mt-4 text-center">
                        <img src="<?= base_url() . 'assets/borial/images/team/13.jpg' ?>" class="img-fluid" alt="">
                        <div>
                ...
                <div class="col-lg-3">
                    <div class="team-member mt-4 text-center">
                        <img src="<?= base_url() . 'assets/borial/images/team/14.jpg' ?>" class="img-fluid" alt="">
                        <div>
    ...
    <section class="section bg-custom">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <h3 class="text-white text-center">Become a part of Borial bussiness community today</h3>
                        ...
                        <div class="col-lg-4">
                            <div class="contact-info">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="ml-5">
                                        <h6 class="text-custom">Home Address</h6>
                                        <p>4317 Straford Park, Campton, KY</p>
                                    </div>
                                </div>
                            </div>
                        </div>
