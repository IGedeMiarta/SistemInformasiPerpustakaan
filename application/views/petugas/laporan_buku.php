        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    ?>
                        <a class='btn btn-primary' target="_blank" href='<?php echo base_url() . 'petugas/laporan_buku_cetak?tanggal_mulai=' . $mulai . '&tanggal_sampai=' . $sampai ?>'><i class='fa fa-print'></i> CETAK</a>
                    <?php
                    }
                    ?>
                </div>
